import Anthropic from "@lobehub/icons/es/Anthropic/index.js";
import Google from "@lobehub/icons/es/Google/index.js";
import Kimi from "@lobehub/icons/es/Kimi/index.js";
import Minimax from "@lobehub/icons/es/Minimax/index.js";
import OpenAI from "@lobehub/icons/es/OpenAI/index.js";
import OpenRouter from "@lobehub/icons/es/OpenRouter/index.js";
import PPIO from "@lobehub/icons/es/PPIO/index.js";
...
export function ProviderLogo({
  ...
  switch (provider) {
    case "anthropic":
      return <LobeIcon Component={Anthropic} label="Anthropic" size={size} />;
    case "openai":
      return <LobeIcon Component={OpenAI} label="OpenAI" size={size} />;
    case "google":
      return <LobeIcon Component={Google} label="Google" size={size} />;
    case "siliconflow":
      return (
        <LobeIcon Component={SiliconCloud} label="SiliconFlow" size={size} />
      );
    case "ppio":
      return <LobeIcon Component={PPIO} label="PPIO" size={size} />;
    case "openrouter":
      return <LobeIcon Component={OpenRouter} label="OpenRouter" size={size} />;
    case "minimax":
      return <LobeIcon Component={Minimax} label="MiniMax" size={size} />;
    case "kimi":
    case "moonshot":
      return <LobeIcon Component={Kimi} label="Kimi" size={size} />;
    case "glm":
    case "zai":
      return <LobeIcon Component={Zhipu} label="GLM" size={size} />;
    case "nexu":
      return (
        <svg
          style={s}
